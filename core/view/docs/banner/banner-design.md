# 商业级 Banner 库技术分享 (设计文档)

## 1. 库的设计思想与优势

在造轮子之前，我们首先要明确目标。我们期望的 Banner 库不仅仅是能用，更要好用、耐用。

### 1.1 设计思想 (Guiding Principles)
...
### 3.2 `BannerAdapter` & `BannerListAdapter` - 数据驱动
...
### 3.3 `InfiniteLoopPageChangeCallback` - 无缝跳转的“大脑”
...
### 3.4 `BannerViewExtensions.kt` - 开发者体验的“最后一公里”
